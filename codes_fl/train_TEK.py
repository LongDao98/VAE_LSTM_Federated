...
def main():
    ...
    print("config datasets:",config1['dataset'],config2['dataset'],config3['dataset'])
    ...
    # create a CNN model
    model_vae_1 = VAEmodel(config1, "Client1")
    model_vae_2 = VAEmodel(config2, "Client2")
    ...
    trainer_vae1 = vaeTrainer(sess1, model_vae_1, data1, config1)
    trainer_vae2 = vaeTrainer(sess2, model_vae_2, data2, config2)
    ...
    lstm_model_1 = lstmKerasModel("Client1", config1)
    lstm_model_2 = lstmKerasModel("Client2", config2)
